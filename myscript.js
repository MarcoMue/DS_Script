...
//twscripts.dev/scripts/twSDK.js?url=https://twscripts.dev/scripts/getIncsForPlayer.js

$.getScript(
  `https://twscripts.dev/scripts/twSDK.js?url=https://twscripts.dev/scripts/getIncsForPlayer.js`,
  ...
  async function () {
    ...
    jQuery
      .ajax(
        `/game.php?screen=info_player&ajax=fetch_villages&player_id=1577303441`
      )
      .done((response) => {
    ...
    function initGetIncsForPlayer() {
      ...
      setTimeout(() => {
        ...
        // ie: "/game.php?village=8914&screen=info_village&id=9414"
        let villagesLinks = [];

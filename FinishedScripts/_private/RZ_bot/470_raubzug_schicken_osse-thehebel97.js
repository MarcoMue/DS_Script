...
(function () {
    ...
    setTimeout(function () {
                ...
                for (let index = 3; index > -1; index--) {
                    ...
                    if (element === "1" && Scaveng === 0) {
                        ...
                        getTroopAmount().forEach(element => {
                            ...
                            eInput.value = Truppenarray[element["unit"]][index] // zb 100
        ...
        function getTroopsPerRzSlot(amount, level, calcType) { // eigentliche Rechnung, ordnet die bh plätze den Raubzügen zu  // hier parameter einfügen für andere Berechnungsarten
            let weigths
            switch (calcType) { // welche Berechnung genutzt wird
                case "equalyLong":
                    weigths = [7.5, 3, 1.5, 1]
            }
            let amounts = []

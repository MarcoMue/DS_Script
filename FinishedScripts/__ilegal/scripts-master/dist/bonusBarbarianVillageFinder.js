(function () {
  ...
  const $902f167bfdc7b30b$export$fb18762d0c18fa09 =
    "https://api.tribalwarshelp.com/graphql";
  var $902f167bfdc7b30b$export$2e2bcd8739ae039 = ({
    query: query,
    variables: variables = {},
  } = {}) => {
  ...
  var $71f792443ec67043$export$2e2bcd8739ae039 = () =>
    $71f792443ec67043$var$translations[window.game_data.locale] ||
    $71f792443ec67043$var$translations.en_DK;
  var $9412d55e353d4b8b$export$2e2bcd8739ae039 = () =>
  ...
  const $db1dd60e5389e0c9$export$c6f77ec2633c38b1 = (
    n = "",
    x = 500,
    y = 500
  ) => {
  ...
  // @grant        none
  // ==/UserScript==
  const $0e40ff93e5ed20a5$var$SERVER =
    $9412d55e353d4b8b$export$2e2bcd8739ae039();
...
`;
  ...
  const $0e40ff93e5ed20a5$var$translations =
    $71f792443ec67043$export$2e2bcd8739ae039();
  ...
  const $0e40ff93e5ed20a5$var$loadBonusVillages = async (bonus) => {
    const { villages: villages } =
      await $902f167bfdc7b30b$export$2e2bcd8739ae039(
        $0e40ff93e5ed20a5$var$buildReqOptions(bonus, 0)
      );
  ...
  const $0e40ff93e5ed20a5$var$searchBonusBarbarianVillages = async (e) => {
    e.preventDefault();
    const villages = await $0e40ff93e5ed20a5$var$loadBonusVillages(
      parseInt(e.target[0].value)
    );
    const coords = TWMap.pos;
    villages.items = villages.items
      .map((item) => {
        return $f1e9793517c51c58$export$2e2bcd8739ae039({}, item, {
          distance: $8f952366ce71d0fe$export$6e378131ceaf17af(
            coords[0],
            coords[1],
            item.x,
            item.y
    ...
    document.querySelector("#" + $0e40ff93e5ed20a5$var$TABLE_ID).innerHTML =
      $0e40ff93e5ed20a5$var$buildTableBodyHTML(villages.items);
  };
              ...
              Array.isArray(villages)
                ? villages
                    .map(
                      (village) => `<tr>
                <td>
                    <a href="${$db1dd60e5389e0c9$export$e537a41a0fc85cc5(
                      village.id
                    )}">
                        ${$db1dd60e5389e0c9$export$c6f77ec2633c38b1(
                          village.name,
                          village.x,
                          village.y
                        )}
                ...
                <td>
                    <a href="#" onclick="return TWMap.focusUserSpecified(${
                      village.x
                        ...
                        $0e40ff93e5ed20a5$var$translations.center
                      }</a>
                </td>
            </tr>`
                    )
  ...
  const $0e40ff93e5ed20a5$var$updateActualCoords = () => {
    document.querySelector(
      "#" + $0e40ff93e5ed20a5$var$ACTUAL_COORDS_ID
    ).innerHTML = `${
      $0e40ff93e5ed20a5$var$translations.actualCoords
  ...
  const $0e40ff93e5ed20a5$var$renderUI = () => {
    const html = `
        ...
        <form>
            <select>
                ${$0e40ff93e5ed20a5$var$getBonuses()
                  .map(
                    (bonus) =>
            ...
            <button type="submit">${
              $0e40ff93e5ed20a5$var$translations.searchBonusBarbarianVillages
            }</button>
        </form>
    ...
    if (!$0e40ff93e5ed20a5$var$container) {
      ...
      document
        .querySelector("#map_big")
        .appendChild($0e40ff93e5ed20a5$var$container);
    }
    $0e40ff93e5ed20a5$var$container.innerHTML = html;
    $0e40ff93e5ed20a5$var$container
      .querySelector("form")
      .addEventListener(
        "submit",
        $0e40ff93e5ed20a5$var$searchBonusBarbarianVillages
      );

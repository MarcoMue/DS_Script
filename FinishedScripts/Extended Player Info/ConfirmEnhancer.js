...
Incomings = {
  ...
  loadSettings: function () {
    ...
    if (
      localStorage.getItem(game_data.world + "confirmenhancersettings") === null
    ) {
      settings.delay = 0;
  ...
  createTable: function (_callback) {
    ...
    $.get(villageUrl, function (html) {
      ...
      if (commands) {
        ...
        delay.innerHTML =
          "<div style='width:100%; height:20px'></div><div width=100%>delay: <input type='number' id='delay' style='width: 100px;'/>     remember: <input type='checkbox' id='remember2'/></div>";
  ...
  fillSnipeTool: function (timestring) {
    ...
    if (
      document
        .getElementById("command-data-form")
        .getElementsByClassName("vis")[0]
        .getElementsByTagName("tbody")[0]
        .getElementsByTagName("tr")[2]
        .getElementsByTagName("td")[0].innerHTML === "Speler:"
    ) {
    ...
    string =
      '{"snipe_time": "' +
      msToDatetimeLocal(date.getTime()) +
      '","snipe_ms": "' +

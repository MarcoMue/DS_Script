  ...
  async function () {
    ...
    (function () {
      ...
      jQuery
        ...
        .catch((error) => {
          UI.ErrorMessage(twSDK.tt("There was an error fetching information!"));
            ...
            for (var y in data.tiles[x]) {
              ...
              if (v) {
                ...
                if (villageCoords.includes(vCoords)) {
                  const currentVillage = villages.find((obj) => obj.id == v.id);
                  let eleDIV = $("<div></div>")
                    .attr("id", "dsm" + v.id)
                    .html(
                  ...
                  villageMapHighlighter(eleDIV, currentVillage.lastpoints);
    ...
    function villageMapHighlighter(el, points) {
      ...
      const watchTowerPoints = ["+90", "+108", "+130", "+155", "+186", "+224"];

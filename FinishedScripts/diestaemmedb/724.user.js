...
win.serverConfig = {
    ...
    villageDetail: "https://diestaemmedb.de/pages/search/villageinfo.php?dorfid=$$village$$",
    reportPage: "https://diestaemmedb.de/pages/report/report.php?id=$$reportID$$",
    allReportsPage: "https://diestaemmedb.de/pages/reports/showreports.php?dorfcoords=($$x$$|$$y$$)",
}

win.$.ajaxSetup({ cache: true });
win.$.getScript("https://media.innogames.com/com_DS_DE/Scriptdatenbank/userscript_main/722_DB_Info_SxR_suilenrocm_MKich.js");